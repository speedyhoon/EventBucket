var f = "",
  s = "",
  c = document.querySelector('[action="/form.eventShooterNew.action"] [name=C]')
    .value;
document.querySelector(
  'form[action="/form.eventShooterNew.action"]'
).oninput = function search(event) {
