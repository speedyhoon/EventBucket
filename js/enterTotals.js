...
function errorMessage(score, $total, $centre) {
  ...
  switch (true) {
    ...
    case score.c[0] > highestCentres:
      errorMessage = `Score has too many centres for a total of ${
        score.t[0]
      }.<br>Please decrease centres to ${highestCentres}<br><b>OR</b><br>increase total to ${
        score.c[0] * highestShot
      }.`;
  }
  if (errorMessage) {
    ...
    popup.style.top =
      $centre.getBoundingClientRect().top + $centre.clientHeight + "px";
