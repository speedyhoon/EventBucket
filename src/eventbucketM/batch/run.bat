...
set go_files=dev.go database.go form.go httpGzip.go pAbout.go pArchive.go pClub.go pEventSettings.go pEvent.go pHome.go pLicence.go pScoreboard.go pShooters.go pStartShooting.go pTotalScores.go schema.go settings.go template.go utils.go validation.go nraa.go sort.go
