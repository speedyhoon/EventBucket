...
//			ranges: []Ranges{{
//				total: shooterList.Scores[sortByRange].Total,
//				centers: shooterList.Scores[sortByRange].Centers,
//				cbs: shooterList.Scores[sortByRange].CountBack1,
//			}},
//			first: shooterList.FirstName,
//			surname: shooterList.Surname,
//		}

//		shooterList.Scores = []Score{
//			shooterList.Scores[sortByRange],
//		}
//		temp := EventShooterSort{
//			FirstName string							`bson:"f"`
//			Surname string								`bson:"s"`
//			Club string									`bson:"b"`//TODO should possibly change to "C"??
//			Class string								`bson:"c"`
