...
<html lang="en-US">
    <head>
        ...
        <title>NRAA |   Listing of known NRAA NRAA_Shooter Details</title>
        <meta name="viewport" content="width=device-width">

        <link rel="profile" href="http://gmpg.org/xfn/11">
        <link rel="pingback" href="http://www.nraa.com.au/xmlrpc.php">

        <link rel="alternate" type="application/rss+xml" title="NRAA &raquo; Listing of known NRAA NRAA_Shooter Details Comments Fee
...
s/2014/06/How-To-Guide-for-New-NRAA_Shooters-at-Bisley-Version-4-May-20141.pdf">&#8216;How To&#8217; Guide for New NRAA_Shooters at Bisle
...
<h1>Listing of known NRAA NRAA_Shooter Details</h1>
<h4></h4>
...
es used to calculate the NRAA_Shooter&#8217;s Grade. THIS SYSTEM IS IN THE TRIAL STAGE ONLY AND THE GRADES SHOWN ARE STILL IN BETA F
...
RADING PLEASE CONTACT THE NRAA OFFICE. It helps to find your own details quicker if you know you own SID. (National NRAA_Shooter ID
...
tem.</p>
<p>The NRAA is also in the process of updating the National NRAA_Shooter Database and developing a new National Ranking System. The
.</p>
...
a href="http://www.nraa.com.au/nraa-shooter-list/">NRAA_Shooter ID</a></li>
...
type NRAA_NRAA_Shooter struct{
	SID int
	Surname,	First_name, Nickname, Club string
}
